...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        app.params = {
			...
			smartSelectSmartCustomDiv: null,	//chan
        ...
        ************   Smart Select   ************
        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
			...
			var smartCustomDiv = smartSelectData.smartCustomDiv !== undefined ? smartSelectData.smartCustomDiv : app.params.smartSelectSmartCustomDiv;
            ...
            var pageHTML =
                ...
                '        </ul>' +
                '      </div>' +
				'      <div class="list-block"><ul><li class="item-content" id="ss'+smartCustomDiv+'">'+arrSlider[smartCustomDiv]+'</li></ul></div>' +	//chan
                '    </div>' +
                '  </div>' +
                '</div>';
